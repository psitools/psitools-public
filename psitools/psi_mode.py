...
#                                  centre=centre)
            self.add_extra_domain(extra_domain_size=[np.abs(centre.imag)*20, np.abs(centre.imag)*20],
                                  centre=centre)
...
class PSIModeAlt(PSIMode):
    ...
    def __init__(self,
        ...
        self.dispersion = psid.PSIDispersion(dust_to_gas_ratio,
                                             ...
                                             size_density).calculate
        # Create rectangular domain
        self.domain = cr.RectangleAlt(real_range, imag_range)
        self.n_sample = n_sample
