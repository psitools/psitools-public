...
batchname = 'reduced_comparison_003'

#Kx=100, Kz=30, epsilon=3.0, taus=0.01)
epstot = 3.0
tsmax = 0.01
kx = 100.0
kz = 30.0
...
tsmins = np.logspace(np.log10(1e-4),np.log10(0.00999),47*2)

arglist = []
for tsmin in tsmins:
    arglist.append({'tsint':(tsmin, tsmax), 'epstot':epstot, 'beta':beta, 'kx':kx, 'kz':kz, 'refine':refine, 'prefix':prefix, 'gridding':gridding})
